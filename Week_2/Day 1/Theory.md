...
Reliability here means: **run the same prompt N times, and the variance in output shape/quality goes down.** That's a testable, measurable property — which is why Week 2 Day 3 (prompt versioning/testing) treats prompts as things you score across runs, not just read once and judge by eye.
...
Week 2 Day 1 adds: the model's OUTPUT QUALITY is also something you
